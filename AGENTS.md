...
Instructions for any coding agent working in this repo (Claude Code loads this via
`CLAUDE.md`'s import; Codex, Cursor, Gemini CLI, Copilot et al. read `AGENTS.md` directly).
